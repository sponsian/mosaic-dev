...
const FrontendRegistrationAction: React.FC<FrontendRegistrationActionProps> = ({ kickbackRate }) => {
  ...
  return myTransactionState.type === "waitingForApproval" ? (
    ...
    <Transaction id={myTransactionId} send={mosaic.registerFrontend.bind(mosaic, kickbackRate)}>
    ...
    <>
      ...
      >
        ...
        <Paragraph sx={{ fontSize: 1, mt: 3 }}>
          ...
          <b>{cut.mul(100).toString()}%</b> of the MSIC rewards earned through this frontend.
        </Paragraph>
