...
export const RiskyTroves: React.FC<RiskyTrovesProps> = ({ pageSize }) => {
  ...
  }, [mosaic, clampedPage, pageSize, reload]);
            ...
            <thead>
              <tr>
                ...
                <th>
                  ...
                  <Box sx={{ fontSize: [0, 1], fontWeight: "body", opacity: 0.5 }}>REEF</Box>
                </th>
                <th>
                  Debt
                    ...
                    <tr key={trove.ownerAddress}>
                      ...
                      <td>
                        <Transaction
                          ...
                          send={mosaic.send.liquidate.bind(mosaic.send, trove.ownerAddress)}
                        >
