...
import { CRITICAL_COLLATERAL_RATIO, Decimal, Difference, Percent } from "@mosaic/lib-base";
            ...
            <InfoIcon
              tooltip={
                <Card variant="tooltip" sx={{ width: "220px" }}>
                  The ratio between the dollar value of the collateral and the debt (in MoUSD) you are
