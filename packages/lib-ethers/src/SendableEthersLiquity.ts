...
/**
 * Ethers-based implementation of {@link @liquity/lib-base#SendableMosaic}.
 *
 * @public
 */
export class SendableEthersMosaic
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.openTrove} */
  async openTrove(
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.closeTrove} */
  closeTrove(
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.adjustTrove} */
  adjustTrove(
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.depositCollateral} */
  depositCollateral(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersMosaicTransaction<TroveAdjustmentDetails>> {
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.withdrawCollateral} */
  withdrawCollateral(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersMosaicTransaction<TroveAdjustmentDetails>> {
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.borrowMoUSD} */
  borrowMoUSD(
    amount: Decimalish,
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.repayMoUSD} */
  repayMoUSD(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersMosaicTransaction<TroveAdjustmentDetails>> {
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.liquidate} */
  liquidate(
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.liquidateUpTo} */
  liquidateUpTo(
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.depositMoUSDInStabilityPool} */
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.withdrawMoUSDFromStabilityPool} */
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.withdrawGainsFromStabilityPool} */
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.transferCollateralGainToTrove} */
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.sendMoUSD} */
  sendMoUSD(
    toAddress: string,
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.sendMSIC} */
  sendMSIC(
    toAddress: string,
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.redeemMoUSD} */
  redeemMoUSD(
    amount: Decimalish,
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.claimCollateralSurplus} */
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.stakeMSIC} */
  stakeMSIC(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersMosaicTransaction<void>> {
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.unstakeMSIC} */
  unstakeMSIC(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersMosaicTransaction<void>> {
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.withdrawGainsFromStaking} */
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.registerFrontend} */
  registerFrontend(
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.approveUniTokens} */
  approveUniTokens(
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.stakeUniTokens} */
  stakeUniTokens(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersMosaicTransaction<void>> {
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.unstakeUniTokens} */
  unstakeUniTokens(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersMosaicTransaction<void>> {
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.withdrawMSICRewardFromLiquidityMining} */
  ...
  /** {@inheritDoc @liquity/lib-base#SendableMosaic.exitLiquidityMining} */
  exitLiquidityMining(
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersMosaicTransaction<void>> {
