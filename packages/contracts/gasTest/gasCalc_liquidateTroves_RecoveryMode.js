...
contract('Gas cost tests', async accounts => {
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 900 MoUSD
    ...
    //1 accts open Trove with 1 ether and withdraw 100 MoUSD
    ...
    // Account 500 opens with 1 ether and withdraws 100 MoUSD
    ...
    // Check initial troves with starting 10E/90MoUSD are still open
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }
  ...
  it("", async () => {
    ...
    //2 accts open Trove with 1 ether and withdraw 100 MoUSD
  ...
  it("", async () => {
    ...
    //3 accts open Trove with 1 ether and withdraw 100 MoUSD
  ...
  it("", async () => {
    ...
    //5 accts open Trove with 1 ether and withdraw 100 MoUSD
  ...
  it("", async () => {
    ...
    //10 accts open Trove with 1 ether and withdraw 100 MoUSD
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 90 MoUSD
    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(10, 'ether'), dec(900, 18))
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }

    //20 accts open Trove with 1 ether and withdraw 100 MoUSD
  ...
  it("", async () => {
    ...
    //30 accts open Trove with 1 ether and withdraw 100 MoUSD
  ...
  it("", async () => {
    ...
    //40 accts open Trove with 1 ether and withdraw 100 MoUSD
  ...
  it("", async () => {
    ...
    // Whale opens trove and fills SP with 1 billion MoUSD
    ...
    // Check SP has 9e28 MoUSD
    const MoUSDinSP = (await stabilityPool.getTotalMoUSDDeposits()).toString()
    assert.equal(MoUSDinSP, dec(9, 28))

    //1 acct opens Trove with 1 ether and withdraw 100 MoUSD
    const _1_Defaulter = accounts.slice(1, 2)
    await th.openTrove_allAccounts(_1_Defaulter, contracts, dec(1, 'ether'), dec(60, 18))
    ...
    // Check initial troves with starting 10E/90MoUSD, and whale's trove, are still open
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }
    assert.isTrue(await sortedTroves.contains(whale))

    //Check MoUSD in SP has decreased but is still > 0
    const MoUSDinSP_After = await stabilityPool.getTotalMoUSDDeposits()
    assert.isTrue(MoUSDinSP_After.lt(web3.utils.toBN(dec(9, 28))))
    assert.isTrue(MoUSDinSP_After.gt(web3.utils.toBN('0')))
  ...
  it("", async () => {
    ...
    //2 acct opens Trove with 1 ether and withdraw 100 MoUSD
    const _2_Defaulters = accounts.slice(1, 3)
    await th.openTrove_allAccounts(_2_Defaulters, contracts, dec(1, 'ether'), dec(60, 18))
  ...
  it("", async () => {
    ...
    //45 accts open Trove with 1 ether and withdraw 100 MoUSD
    const _45_Defaulters = accounts.slice(1, 46)
    await th.openTrove_allAccounts(_45_Defaulters, contracts, dec(100, 'ether'), dec(9500, 18))
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 110 MoUSD
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraws MoUSD

    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(1000, 'ether'), dec(13000, 18))

    // Account 500 opens with 1 ether and withdraws MoUSD
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 180 MoUSD
    await borrowerOperations.openTrove(_100pct, dec(13000, 18), accounts[500], ZERO_ADDRESS,{ from: accounts[500], value: dec(100, 'ether') })
