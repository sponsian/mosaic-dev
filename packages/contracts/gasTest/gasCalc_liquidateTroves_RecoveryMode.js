...
contract('Gas cost tests', async accounts => {
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 900 MEUR
    ...
    //1 accts open Trove with 1 ether and withdraw 100 MEUR
    ...
    // Account 500 opens with 1 ether and withdraws 100 MEUR
    ...
    // Check initial troves with starting 10E/90MEUR are still open
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }
  ...
  it("", async () => {
    ...
    //2 accts open Trove with 1 ether and withdraw 100 MEUR
  ...
  it("", async () => {
    ...
    //3 accts open Trove with 1 ether and withdraw 100 MEUR
  ...
  it("", async () => {
    ...
    //5 accts open Trove with 1 ether and withdraw 100 MEUR
  ...
  it("", async () => {
    ...
    //10 accts open Trove with 1 ether and withdraw 100 MEUR
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 90 MEUR
    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(10, 'ether'), dec(900, 18))
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }

    //20 accts open Trove with 1 ether and withdraw 100 MEUR
  ...
  it("", async () => {
    ...
    //30 accts open Trove with 1 ether and withdraw 100 MEUR
  ...
  it("", async () => {
    ...
    //40 accts open Trove with 1 ether and withdraw 100 MEUR
  ...
  it("", async () => {
    ...
    // Whale opens trove and fills SP with 1 billion MEUR
    ...
    // Check SP has 9e28 MEUR
    const MEURinSP = (await stabilityPool.getTotalMEURDeposits()).toString()
    assert.equal(MEURinSP, dec(9, 28))

    //1 acct opens Trove with 1 ether and withdraw 100 MEUR
    const _1_Defaulter = accounts.slice(1, 2)
    await th.openTrove_allAccounts(_1_Defaulter, contracts, dec(1, 'ether'), dec(60, 18))
    ...
    // Check initial troves with starting 10E/90MEUR, and whale's trove, are still open
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }
    assert.isTrue(await sortedTroves.contains(whale))

    //Check MEUR in SP has decreased but is still > 0
    const MEURinSP_After = await stabilityPool.getTotalMEURDeposits()
    assert.isTrue(MEURinSP_After.lt(web3.utils.toBN(dec(9, 28))))
    assert.isTrue(MEURinSP_After.gt(web3.utils.toBN('0')))
  ...
  it("", async () => {
    ...
    //2 acct opens Trove with 1 ether and withdraw 100 MEUR
    const _2_Defaulters = accounts.slice(1, 3)
    await th.openTrove_allAccounts(_2_Defaulters, contracts, dec(1, 'ether'), dec(60, 18))
  ...
  it("", async () => {
    ...
    //45 accts open Trove with 1 ether and withdraw 100 MEUR
    const _45_Defaulters = accounts.slice(1, 46)
    await th.openTrove_allAccounts(_45_Defaulters, contracts, dec(100, 'ether'), dec(9500, 18))
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 110 MEUR
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraws MEUR

    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(1000, 'ether'), dec(13000, 18))

    // Account 500 opens with 1 ether and withdraws MEUR
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 180 MEUR
    await borrowerOperations.openTrove(_100pct, dec(13000, 18), accounts[500], ZERO_ADDRESS,{ from: accounts[500], value: dec(100, 'ether') })
