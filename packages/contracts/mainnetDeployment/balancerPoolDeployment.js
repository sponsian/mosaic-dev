...
const MEUR = '0x5f98805A4E8be255a32880FDeC7F6728C6568bA0';
const CHAINLINK_ETHUSD_PROXY = '0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419';

const tokens = [MEUR, WETH];
const weights = [toBigNum(dec(4, 17)), toBigNum(dec(6, 17))];

const NAME = 'WETH/MEUR Pool';
const SYMBOL = '60WETH-40MEUR';
...
async function main() {
  ...
  */
  ...
  th.logBN('Initial MEUR', msic_balance);
  ...
  console.log('Approve MEUR gas: ', approveMousdReceipt.gasUsed.toString());
