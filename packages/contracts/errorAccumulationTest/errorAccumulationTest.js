...
contract('TroveManager', async accounts => {
  ...
  */
  ...
  it("11 accounts. 10 liquidations. Check (ActivePool - DefaultPool) differences", async () => {
    ...
    let totalMoUSDDebtPoolDifference = web3.utils.toBN(0)

    for (account of accounts.slice(1, 11)) {
      const activePoolETH = await activePool.getETH()
      const activePoolMoUSDDebt = await activePool.getMoUSD()
  ...
  */
  ...
  it("11 accounts. 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
    ...
    const totalMoUSDRewards = (totalColl.mul(L_MoUSDDebt)).div(_1e18_BN)
  ...
  */
  ...
  it("11 accounts. 10 liquidations, partial offsets. Check (DefaultPool - totalRewards) differences", async () => {
   // Acct 99 opens trove with 100 MoUSD
    await borrowerOperations.openTrove(0, 0,  accounts[99], { from: accounts[99], value: dec(100, 'ether') })
    await borrowerOperations.withdrawMoUSD(0, dec(100, 18), accounts[99], {from: accounts[99]})
    ...
    // On loop: Account[99] adds 10 MoUSD to pool -> a trove gets liquidated and partially offset against SP, emptying the SP
    for (account of accounts.slice(1, 11)) {
    ...
    const totalMoUSDRewards_Distribution = (totalColl.mul(L_MoUSDDebt)).div(_1e18_BN)
  ...
  */
  ...
  it("101 accounts. 100 liquidations, partial offsets. Check (DefaultPool - totalRewards) differences", async () => {
    // Acct 99 opens trove with 100 MoUSD
     await borrowerOperations.openTrove(0, 0,  accounts[999], { from: accounts[999], value: dec(100, 'ether') })
     await borrowerOperations.withdrawMoUSD(0, dec(100, 18), accounts[999], {from: accounts[999]})
  ...
  */
  ...
  it("11 accounts. 10 Borrowers add to SP. 1 liquidation, 10 Borrowers withdraw all their SP funds", async () => {
    ...
    /* Sometimes, the error causes the last MoUSD withdrawal from SP to underflow and fail. 
    ...
    const SP_MoUSD = await stabilityPool.getTotalMoUSDDeposits()  
   ...
   */
   ...
   it("11 accounts. 10 Borrowers add to SP, random MoUSD amounts. 1 liquidation, 10 Borrowers withdraw all their SP funds", async () => {
    // Acct 99 opens trove with 100 MoUSD
     await borrowerOperations.openTrove(0, 0,  accounts[999], { from: accounts[999], value: dec(100, 'ether') })
     await borrowerOperations.withdrawMoUSD(0, dec(100, 18), accounts[999], {from: accounts[999]})
   ...
   it("101 accounts. 100 Borrowers add to SP, random MoUSD amounts. 1 liquidation, 100 Borrowers withdraw all their SP funds", async () => {
    // Acct 99 opens trove with 100 MoUSD
     await borrowerOperations.openTrove(0, 0,  accounts[999], { from: accounts[999], value: dec(100, 'ether') })
     await borrowerOperations.withdrawMoUSD(0, dec(100, 18), accounts[999], {from: accounts[999]})
 ...
 it("501 accounts. 500 Borrowers add to SP, random MoUSD amounts. 1 liquidation, 500 Borrowers withdraw all their SP funds", async () => {
  // Acct 99 opens trove with 100 MoUSD
   await borrowerOperations.openTrove(0, 0, accounts[999], { from: accounts[999], value: dec(100, 'ether') })
   await borrowerOperations.withdrawMoUSD(0, dec(100, 18), accounts[999], {from: accounts[999]})
...
it("11 accounts with random REEF and proportional MoUSD (180:1). 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
  ...
  await th.openTrove_allAccounts_randomETH_ProportionalMoUSD(100000000, 200000000, accounts.slice(0, 11), contracts, 180)
...
/* 
  ...
  */
  ...
  it("101 accounts with random REEF and proportional MoUSD (180:1). 100 liquidations. Check 1) (DefaultPool - totalDistributionRewards) difference, and 2) ", async () => {
    ...
    // Troves open with 100-200 million ether and proportional MoUSD Debt
    await th.openTrove_allAccounts_randomETH_ProportionalMoUSD(100000000, 200000000, accounts.slice(0, 101), contracts, 180)
