...
//     console.log(`Testnet: Latest REEF:USD price from aggregator: ${price_aggregatorTestnet}`);
...
//     console.log(`Testnet: Latest REEF:USD price from deployed PriceFeed: ${price_PriceFeedTestnet}`)
...
//     console.log(`Mainnet: Latest REEF:USD price from aggregator: ${price_aggregatorMainnet}`);
...
//     console.log(`Mainnet: Latest REEF:USD price from deployed PriceFeed: ${price_PriceFeedMainnet}`)
