...
const ABDKOperations = async () => {
    ...
    // Example computaton: MoUSD -> Ether price conversion

    // price = 200.12345678, stored as uint
    // convert 6123456700909.123456789123456789 MoUSD to Ether
    // amount = 6123456700909.123456789123456789 MoUSD / 200.12345678 
    ...
    */
    ...
    /* TODO: will L_ETH, L_MoUSD overflow if stored as 64.64? Possibly need to store as uint, divide by 1e18, then use
    the resulting 64.64  */
    ...
    /* 
    --- Using ABDK functions in Mosaic ---
