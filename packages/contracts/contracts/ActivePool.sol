...
/*
 * The Active Pool holds the ETH collateral and MoUSD debt (but not MoUSD tokens) for all active troves.
 *
 * When a trove is liquidated, it's ETH and MoUSD debt are transferred from the Active Pool, to either the
