...
# Test output
The following is the output of a complete test run, made on commit [`a1824dd8`](https://github.com/mosaic/dev/tree/a1824dd88f4928b424cae372d59c4455d5c9a2c2), from April 16th, 2021.
...
totalMSICIssued_2: 30370113195977152000000
      ...
      ✓ withdrawFromSP(): Depositors with equal initial deposit withdraw correct MSIC gain. No liquidations. No front end. (1479ms)
      ✓ withdrawFromSP(): Depositors with varying initial deposit withdraw correct MSIC gain. No liquidations. No front end. (1345ms)
...
alice deposit: 0
  ...
  Contract: StabilityPool
    Stability Pool Mechanisms
      ...
      ✓ provideToSP(), new deposit: depositor does not receive any MSIC rewards (671ms)
      ✓ provideToSP(), new deposit after past full withdrawal: depositor does not receive any MSIC rewards (1679ms)
      ...
      ✓ provideToSP(), topup: tagged front end receives MSIC rewards (1036ms)
      ...
      ✓ withdrawFromSP(), partial withdrawal: tagged front end receives MSIC rewards (1245ms)
      ...
      ✓ withdrawETHGainToTrove(), eligible deposit: depositor receives MSIC rewards (1607ms)
...
gasUsed:  636956
  ...
  Contract: TroveManager
    ...
    ✓ batchLiquidateTroves: when SP > 0, triggers MSIC reward event - increases the sum G (1428ms)
