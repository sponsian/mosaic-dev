...
export function handleMEURBorrowingFeePaid(event: MEURBorrowingFeePaid): void {
  setBorrowingFeeOfLastTroveChange(event.params._MEURFee);
  increaseTotalBorrowingFeesPaid(event.params._MEURFee);
}
