...
|  [borrowMEUR(amount, maxBorrowingRate)](./lib-base.sendablemosaic.borrowmeur.md) | Adjust existing Trove by borrowing more MEUR. |
...
|  [depositMEURInStabilityPool(amount, frontendTag)](./lib-base.sendablemosaic.depositmeurinstabilitypool.md) | Make a new Stability Deposit, or top up existing one. |
...
|  [redeemMEUR(amount, maxRedemptionRate)](./lib-base.sendablemosaic.redeemmeur.md) | Redeem MEUR to native currency (e.g. Ether) at face value. |
...
|  [repayMEUR(amount)](./lib-base.sendablemosaic.repaymeur.md) | Adjust existing Trove by repaying some of its debt. |
|  [sendMEUR(toAddress, amount)](./lib-base.sendablemosaic.sendmeur.md) | Send MEUR tokens to an address. |
...
|  [withdrawMEURFromStabilityPool(amount)](./lib-base.sendablemosaic.withdrawmeurfromstabilitypool.md) | Withdraw MEUR from Stability Deposit. |
