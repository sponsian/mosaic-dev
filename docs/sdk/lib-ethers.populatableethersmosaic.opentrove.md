...
[Home](./index.md) &gt; [@liquity/lib-ethers](./lib-ethers.md) &gt; [PopulatableEthersMosaic](./lib-ethers.populatableethersmosaic.md) &gt; [openTrove](./lib-ethers.populatableethersmosaic.opentrove.md)

## PopulatableEthersMosaic.openTrove() method
...
Promise&lt;[PopulatedEthersMosaicTransaction](./lib-ethers.populatedethersmosaictransaction.md)<!-- -->&lt;[TroveCreationDetails](./lib-base.trovecreationdetails.md)<!-- -->&gt;&gt;
