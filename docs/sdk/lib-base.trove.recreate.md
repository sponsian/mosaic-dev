...
[Home](./index.md) &gt; [@mosaic/lib-base](./lib-base.md) &gt; [Trove](./lib-base.trove.md) &gt; [recreate](./lib-base.trove.recreate.md)

## Trove.recreate() method

Calculate the parameters of an [openTrove()](./lib-base.transactablemosaic.opentrove.md) transaction that will result in the given Trove.
