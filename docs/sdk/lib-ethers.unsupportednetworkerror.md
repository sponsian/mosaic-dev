...
[Home](./index.md) &gt; [@mosaic/lib-ethers](./lib-ethers.md) &gt; [UnsupportedNetworkError](./lib-ethers.unsupportednetworkerror.md)
...
Thrown by [ReadableEthersMosaic.connect()](./lib-ethers.readableethersmosaic.connect_1.md) and [EthersMosaic.connect()](./lib-ethers.ethersmosaic.connect_1.md)<!-- -->.
