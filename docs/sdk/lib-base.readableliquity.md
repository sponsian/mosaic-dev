...
|  [getLiquidityMiningStake(address)](./lib-base.readablemosaic.getliquidityminingstake.md) | Get the amount of Uniswap ETH/MoUSD LP tokens currently staked by an address in liquidity mining. |
...
|  [getTotalStakedUniTokens()](./lib-base.readablemosaic.gettotalstakedunitokens.md) | Get the total amount of Uniswap ETH/MoUSD LP tokens currently staked in liquidity mining. |
...
|  [getUniTokenAllowance(address)](./lib-base.readablemosaic.getunitokenallowance.md) | Get the liquidity mining contract's allowance of a holder's Uniswap ETH/MoUSD LP tokens. |
|  [getUniTokenBalance(address)](./lib-base.readablemosaic.getunitokenbalance.md) | Get the amount of Uniswap ETH/MoUSD LP tokens held by an address. |
