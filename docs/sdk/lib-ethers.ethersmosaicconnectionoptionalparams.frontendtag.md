...
For example [depositMEURInStabilityPool(amount, frontendTag?)](./lib-ethers.ethersmosaic.depositmeurinstabilitypool.md) will tag newly made Stability Deposits with this address when its `frontendTag` parameter is omitted.
