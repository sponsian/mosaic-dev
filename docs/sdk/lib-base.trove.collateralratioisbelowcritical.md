...
[Home](./index.md) &gt; [@mosaic/lib-base](./lib-base.md) &gt; [Trove](./lib-base.trove.md) &gt; [collateralRatioIsBelowCritical](./lib-base.trove.collateralratioisbelowcritical.md)
...
Can be used to check whether the Mosaic protocol is in recovery mode by using it on the return value of [getTotal()](./lib-base.readablemosaic.gettotal.md)<!-- -->. For example:
