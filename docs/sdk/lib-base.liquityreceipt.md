...
[Home](./index.md) &gt; [@liquity/lib-base](./lib-base.md) &gt; [MosaicReceipt](./lib-base.mosaicreceipt.md)
...
```typescript
export declare type MosaicReceipt<R = unknown, D = unknown> = PendingReceipt | MinedReceipt<R, D>;
```
