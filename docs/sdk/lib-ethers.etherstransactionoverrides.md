...
[Home](./index.md) &gt; [@mosaic/lib-ethers](./lib-ethers.md) &gt; [EthersTransactionOverrides](./lib-ethers.etherstransactionoverrides.md)

## EthersTransactionOverrides interface

Optional parameters taken by [EthersMosaic](./lib-ethers.ethersmosaic.md) transaction functions.
